		...
		<div class="row">
			<div class="col-md-6 mx-auto">
				<div class="info-container">
					...
					<form method="post" action="<%=request.getContextPath()%>/TransferenciaServlet">
						...
						<label class="mt-3">Cuenta Destino:</label>
						...
						<input type="text" name="monto" class="form-control" required pattern="\d+" title="Solo números positivos sin signos.">
						...
						<div class="d-flex gap-2 mt-3">
							...
							<a href="<%=request.getContextPath()%>/TransferenciasHomeServlet" class="btn btn-secondary px-4">Volver</a>
						</div>
