...
<body>
	...
	<div class="container">
		<div class="row mt-4">
			...
			<div class="col-md-4">
				<div class="info-container">
					...
					<div class="info-field">
						<label class="field-label">Tipo:</label> <span class="field-value"><%=cuenta.getDescripcionTipoDeCuenta()%></span>
					</div>

					<div class="info-field">
						<label class="field-label">Saldo:</label> <span
							class="saldo-positivo">$<%=cuenta.getSaldo()%></span>
					</div>

					<div class="info-field">
						<label class="field-label">CBU:</label> <span class="cbu-text"><%=cuenta.getCbu()%></span>
					</div>

					<div class="mt-3 text-center">
						<a
							href="${pageContext.request.contextPath}/VerTodoCuentaServlet?idCuenta=<%= cuenta.getId() %>"
			...
			%>
			<div class="col-12">
				<div class="alert alert-info text-center" role="alert">No hay
					cuentas disponibles en este momento.</div>
			</div>
			<%
			}
			%>
