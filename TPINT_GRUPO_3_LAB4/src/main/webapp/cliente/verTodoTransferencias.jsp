...
<body>
	...
	String cuentaParam = (request.getParameter("cuenta") != null && !"null".equals(request.getParameter("cuenta")))
	...
	<div class="container mt-5">
		...
		<form method="get"
			...
			<div class="col-md-3">
				<label for="fechaDesde" class="form-label">Fecha desde</label> <input
					type="date" class="form-control" name="fechaDesde"
					value="<%=fechaDesdeParam%>">
			</div>
			<div class="col-md-3">
				<label for="fechaHasta" class="form-label">Fecha hasta</label> <input
					type="date" class="form-control" name="fechaHasta"
					value="<%=fechaHastaParam%>">
			</div>
			<div class="col-md-2">
				<label for="montoMin" class="form-label">Monto mínimo</label> <input
					type="number" step="0.01" class="form-control" name="montoMin"
					value="<%=montoMinParam%>">
			</div>
			<div class="col-md-2">
				<label for="montoMax" class="form-label">Monto máximo</label> <input
					type="number" step="0.01" class="form-control" name="montoMax"
					value="<%=montoMaxParam%>">
			</div>
			<div class="col-md-2">
		...
		<div class="d-flex justify-content-center mt-3 gap-2">
			...
			boolean haySiguiente = (request.getAttribute("haySiguiente") != null) ? (boolean) request.getAttribute("haySiguiente")
					: false;
			String baseUrl = request.getContextPath() + "/TransferenciasVerTodoServlet?";
			String parametros = "fechaDesde=" + fechaDesdeParam + "&fechaHasta=" + fechaHastaParam + "&montoMin=" + montoMinParam
					+ "&montoMax=" + montoMaxParam + "&cuenta=" + cuentaParam;
			%>
