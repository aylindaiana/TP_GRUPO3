...
@WebServlet("/VerDatosClienteServlet")
public class VerDatosClienteServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (idObj != null) {
            ...
            request.getRequestDispatcher("/cliente/verUsuarioCliente.jsp").forward(request, response);
        } else {
